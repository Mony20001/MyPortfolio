                        ...
                        {activeTab === 'bio' && (
                            ...
                            `} style={{ transitionDelay: '150ms' }}>
                                ...
                                <div className="space-y-3 text-pink-700">
                                    <p>
                                        🐱 សួស្តីអ្នកទាំងអស់គ្នា!!ខ្ញុំគឺ មុនី ជានិស្សិតឆ្នាំទី២ផ្នែកអាយធីនៃសាកលវិទ្យាល័យភ្នំពេញ។
                                        ខ្ញុំមានក្តីស្រមៃចង់ក្លាយជាFull-Stack Developmentមួយរូបដែលមានសមត្ថភាពអាចអភិវឌ្ឈ
                                        កម្មវិធីទាំង App and Website នៅពេលអនាគត។
                                    </p>
                                    <p>
                                        💖 ទីកន្លែងកំណើត : ភូមិអណ្តូងជ័យ ឃុំក្រែក ស្រុកពញាក្រែក ខេត្តកំពង់ចាម 
                                        (ខេត្តត្បូងឃ្មុំ)
                                    </p>
                                    <p>
